...
# 
# ROOST_METHOD_HASH=ee4a522da7
# ROOST_METHOD_SIG_HASH=39725614c0
# 
#  ########## Scenario ########## 
# 
# {
...
#   rule: null,
#   scenario: {
#     title: 'Scenario: Retrieve all products when no products exist',
#     steps: 'Given the product repository is empty\n' +

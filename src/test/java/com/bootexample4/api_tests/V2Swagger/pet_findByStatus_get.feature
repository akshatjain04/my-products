...
Feature: Test /v2/pet/findByStatus endpoint
  ...
  Background:
    * def urlBase = karate.properties['url1_swagger_URL_BASE'] || karate.get('urlBase', 'http://localhost:4010')
    * url urlBase
    * configure headers = { Authorization: #(karate.properties['url1_swagger_AUTH_TOKEN']) }

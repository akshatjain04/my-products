  ...
  class ZbIoCredentialWalletApiRefsHeadsMainApiCredentialregisterWallet100ResolvedTest {
      ...
      @Test
      void testAll() {
          String apiHostServer = System.getenv().getOrDefault("url1_swagger_URL_BASE", "http://localhost:4010");
String url1swaggerauthtoken = System.getenv().getOrDefault("url1_swagger_AUTH_TOKEN", "dummy_url1_swagger_AUTH_TOKEN");
String apiHostServer = System.getenv().getOrDefault("url2_credentialregister-wallet-1.0.0-resolved_URL_BASE", "http://localhost:4010");

...
public class listenerProductOrderStateChangeEventPostTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/bootexample4/RoostTest/listener_productOrderStateChangeEventPostTest.csv", envVarsList);
    }

...
public class credentialsIdGetTest {
    ...
    public void credentialsIdGet_Test() throws JSONException {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("url2_credentialregister-wallet-1.0.0-resolved_BASE_URL") != null && !testData.get("url2_credentialregister-wallet-1.0.0-resolved_BASE_URL").isEmpty()) ? testData.get("url2_credentialregister-wallet-1.0.0-resolved_BASE_URL"):undefined;  

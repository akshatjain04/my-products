...
public class availabilityCheckPostTest {
    ...
    public void availabilityCheckPost_Test() throws JSONException {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("url1_tresourcePoolManagement_(2)_BASE_URL") != null && !testData.get("url1_tresourcePoolManagement_(2)_BASE_URL").isEmpty()) ? testData.get("url1_tresourcePoolManagement_(2)_BASE_URL"): undefined;  

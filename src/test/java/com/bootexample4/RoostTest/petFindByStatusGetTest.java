...
public class petFindByStatusGetTest {
    ...
    public void petFindByStatusGet_Test() throws JSONException {
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("url2_petstore_BASE_URL") != null && !testData.get("url2_petstore_BASE_URL").isEmpty()) ? testData.get("url2_petstore_BASE_URL"): "https://petstore.swagger.io/v2";  

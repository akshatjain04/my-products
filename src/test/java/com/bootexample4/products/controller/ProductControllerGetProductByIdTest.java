...
public class ProductControllerGetProductByIdTest {
	...
	// Commenting the below test case as it is not applicable.
	// getProductById method does not handle null id and it should not as @PathVariable
	// cannot be null
	/*
	 * @Test
	 *
	 * @Tag("boundary") public void shouldThrowExceptionWhenIdIsNull() {
